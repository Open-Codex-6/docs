...
#table(
  ...
  table.cell(rowspan: 5)[`genetic.py (feedback)`],
  ...
  [`FeedbackMutationPromptGeneration`], [Prompt 类：根据指令与反馈集合生成改写后的指令文本（即将反馈落地为新的 prompt）。],

  table.cell(rowspan: 1)[`genetic.py (misc)`],
  ...
  table.cell(rowspan: 1)[`dspy_adapter.py`],
  [ `pydantic_prompt_to_dspy_signature`, `ragas_dataset_to_dspy_examples`, `create_dspy_metric`, `setup_dspy_llm` ], [适配器集合：负责把 Ragas 的 PydanticPrompt、注释数据与 Loss 转换为 DSPy 所需的 Signature、Example 与 metric 函数，并配置 DSPy 使用的 LLM。],

  table.cell(rowspan: 1)[`dspy_llm_wrapper.py`],
...
#table(
  ...
  table.cell(rowspan: 1)[`gdrive_backend.py`],
...
#table(
  ...
  table.cell(rowspan: 1)[`langchain.py`],
  ...
  table.cell(rowspan: 2)[`helicone.py`],
